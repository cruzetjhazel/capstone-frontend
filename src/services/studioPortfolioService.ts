...
export const studioPortfolioService = {
...
// --- Backend pieces this relies on that I haven't seen and can't patch blind: ---
// 1. ArchivePortfolioImageAction should set `archived_at = now()` when archiving.
// 2. RestorePortfolioImageAction should set `archived_at = null` when restoring.
// 3. PortfolioImageResource::toArray() needs an `'archived_at' => $this->archived_at,` line.